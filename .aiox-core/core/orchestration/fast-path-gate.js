...
const AUTOMATION_PATTERNS_FROZEN = Object.freeze(
  [
    ...
    },
    {
      ...
      weight: 3,
      pattern:
        /\b(replace|rename|populate|fill|complete|update|convert|transform|normalize|format)\b/i,
    },
    {
      id: "map-then-apply",
      weight: 2,
...
function scoreFastPath({ automationSignals, riskSignals, files, structuredFileCount, batchSize }) {
  ...
  const rawScore =
    automationWeight + fileWeight + structuredWeight + batchWeight - riskWeight * 1.35;
